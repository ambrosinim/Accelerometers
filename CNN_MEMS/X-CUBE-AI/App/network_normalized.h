...
#ifndef AI_NETWORK_NORMALIZED_H
#define AI_NETWORK_NORMALIZED_H
#pragma once

#include "network_normalized_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_NORMALIZED_MODEL_NAME          "network_normalized"
#define AI_NETWORK_NORMALIZED_ORIGIN_MODEL_NAME   "lit_normalized"

/******************************************************************************/
#define AI_NETWORK_NORMALIZED_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_NETWORK_NORMALIZED_IN_NUM        (1)
#define AI_NETWORK_NORMALIZED_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 25, 3, 1, 1, NULL), \
}
#define AI_NETWORK_NORMALIZED_IN_SIZE { \
  AI_NETWORK_NORMALIZED_IN_1_SIZE, \
}
#define AI_NETWORK_NORMALIZED_IN_SIZE_BYTES { \
  AI_NETWORK_NORMALIZED_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_NORMALIZED_IN_1_HEIGHT      (25)
#define AI_NETWORK_NORMALIZED_IN_1_WIDTH       (3)
#define AI_NETWORK_NORMALIZED_IN_1_CHANNEL     (1)
#define AI_NETWORK_NORMALIZED_IN_1_SIZE        (25 *  3 *  1)
#define AI_NETWORK_NORMALIZED_IN_1_SIZE_BYTES  (AI_NETWORK_NORMALIZED_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_NETWORK_NORMALIZED_OUT_NUM       (1)
#define AI_NETWORK_NORMALIZED_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 3, 1, NULL), \
}
#define AI_NETWORK_NORMALIZED_OUT_SIZE { \
  AI_NETWORK_NORMALIZED_OUT_1_SIZE, \
}
#define AI_NETWORK_NORMALIZED_OUT_SIZE_BYTES { \
  AI_NETWORK_NORMALIZED_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_NORMALIZED_OUT_1_CHANNEL     (3)
#define AI_NETWORK_NORMALIZED_OUT_1_SIZE        (3)
#define AI_NETWORK_NORMALIZED_OUT_1_SIZE_BYTES  (AI_NETWORK_NORMALIZED_OUT_1_SIZE*4)

/******************************************************************************/
#define AI_NETWORK_NORMALIZED_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_normalized
 ...
 * @ref ai_network_normalized_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_normalized_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_NORMALIZED_*
 * defines into file @ref network_normalized.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_normalized_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_NORMALIZED_H */
